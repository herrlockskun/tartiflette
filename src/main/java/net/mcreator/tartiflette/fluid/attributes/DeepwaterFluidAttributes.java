...
package net.mcreator.tartiflette.fluid.attributes;
...
public class DeepwaterFluidAttributes extends FluidAttributes {
	public static CustomBuilder builder(ResourceLocation stillTexture, ResourceLocation flowingTexture) {
		return new CustomBuilder(stillTexture, flowingTexture, DeepwaterFluidAttributes::new);
	}
	...
	protected DeepwaterFluidAttributes(Builder builder, Fluid fluid) {
		super(builder, fluid);
	}
