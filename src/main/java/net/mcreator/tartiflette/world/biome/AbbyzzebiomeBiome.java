...
public class AbbyzzebiomeBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-13893588).waterColor(-13434625).waterFogColor(-16764109)
				.skyColor(-13893588).foliageColorOverride(-15021057).grassColorOverride(-11851009)
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("tartiflette:tree_abbyzzebiome",
				FeatureUtils.register("tartiflette:tree_abbyzzebiome", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
						BlockStateProvider.simple(TartifletteModBlocks.ABBYZZEWOOD.get().defaultBlockState()), new StraightTrunkPlacer(7, 2, 0),
