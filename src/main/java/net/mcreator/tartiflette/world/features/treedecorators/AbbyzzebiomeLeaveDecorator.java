...
public class AbbyzzebiomeLeaveDecorator extends LeaveVineDecorator {
	public static final AbbyzzebiomeLeaveDecorator INSTANCE = new AbbyzzebiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("abbyzzebiome_tree_leave_decorator");
