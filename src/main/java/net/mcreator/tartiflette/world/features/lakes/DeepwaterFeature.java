...
package net.mcreator.tartiflette.world.features.lakes;
...
public class DeepwaterFeature extends LakeFeature {
	public static DeepwaterFeature FEATURE = null;
	public static Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new DeepwaterFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("tartiflette:deepwater", FEATURE, new LakeFeature.Configuration(
				BlockStateProvider.simple(TartifletteModBlocks.DEEPWATER.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("tartiflette:deepwater", CONFIGURED_FEATURE,
